 ...
 */
public class TreeDequeMap<K, V> extends TreeMap<K, Deque<V>>
{
	private static final long serialVersionUID = 3805197943005742717L;
	 ...
	 * @param comparator the initial capacity.
	 */
	public TreeDequeMap(Comparator<K> comparator)
	{
		super(comparator);
	}
