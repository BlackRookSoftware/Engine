...
public interface EngineSettingsListener
{
	 ...
	 * @param properties the Properties object to store settings into.
	 */
	public void onSaveUserSettings(Properties properties);
	 ...
	 * @param properties the Properties object to store settings into.
	 */
	public void onSaveGlobalSettings(Properties properties);
	 ...
	 * @param properties the Properties object to read settings from.
	 */
	public void onLoadUserSettings(Properties properties);
	 ...
	 * @param properties the Properties object to read settings from.
	 */
	public void onLoadGlobalSettings(Properties properties);
